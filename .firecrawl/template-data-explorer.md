...
\> "Write a SQL query that joins orders to users on user\_id, filters for orders after 2024-01-01 with total > $50, groups by user, and returns the top 10 users by order count."
